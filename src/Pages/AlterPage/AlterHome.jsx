...
import AccountingMastery from "../CreatePage/AccountingMastery";
import Inventory from "../CreatePage/Inventory";
import TaxCompliance from "../CreatePage/tax";
        ...
        <main className="bg-gradient-to-br from-orange-50 via-white to-orange-100 h-[90vh] w-[83vw] p-5 overflow-y-auto">
            ...
            <div className="mb-6">
                ...
                <p className="text-slate-500 mt-1">
                     manage all your accounting, inventory and compliance masters
                </p>
            </div>

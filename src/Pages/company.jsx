        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 px-1">
          {CompanyData.map((Compdata, ui) => {
            ...
            return (
              <div
                key={ui}
                className="group bg-white border border-gray-100 px-4 py-3.5 rounded-2xl
                           flex items-center justify-between
                           shadow-[0_1px_3px_rgba(16,24,40,0.06)]
                           hover:shadow-[0_8px_20px_rgba(13,110,253,0.10)] hover:border-blue-200
              ...
              >
                ...
                {/* Select Button */}
                <button
                  className="shrink-0 bg-[#0d6efd] hover:bg-[#0250c5] active:scale-95
                             text-white text-sm font-medium px-5 py-2 rounded-xl
                             transition-all duration-150
                             shadow-[0_1px_2px_rgba(13,110,253,0.3)]
